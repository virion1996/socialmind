...
/*         let user_dados = db_psico.data[user_dados_index]; */
    ...
    $("#sobre_job").val(`${usuarioCorrente.sobre_job}`);
...
$(document).ready(function () {
    ...
    $("#sobre").focusout( () => {
        ...
        $("#sobre_job").focusout( () => {
            ...
            db_psico.data[user_dados_index].sobre_job = $("#sobre_job").val();
            usuarioCorrente.sobre_job = $("#sobre_job").val();
